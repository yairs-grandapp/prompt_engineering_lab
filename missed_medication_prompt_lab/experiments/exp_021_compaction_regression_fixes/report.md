This experiment corrects the regressions introduced by the prompt compaction in
exp_020. The compacted prompt (prompt_v17) reduced input cost by approximately 58
percent but lowered the outcome pass rate from 100/100 to 98/100 and caused a
self-referential closing phrase ("I'm here to support you") to recur in fifteen
scenarios, versus one in exp_019. Analysis attributed all three effects to the
removal of reinforcing repetition in specific rules rather than to any rule being
deleted.

Prompt_v18 restores emphasis in three places while retaining the remainder of the
compaction (it is approximately 58 percent smaller than prompt_v16). First, the
prohibition on self-referential closings is reinstated as an explicit high-priority
rule with its full phrase list. Second, the boundary between a commitment to take the
medication now ("on it now", "doing it now") and a past action ("I already took it")
is stated on both outcome rules, addressing scenario_75, in which a commitment was
classified as already-taken. Third, the medication-box confirmation is constrained to
a single request, so that a clear statement that the dose came from the box finalizes
DID_TAKE immediately, addressing scenario_45, in which the assistant re-asked and then
validated as could-not-validate after silence. The deterministic could-not-validate
message injection remains in effect. The experiment is evaluated as an A/B against
exp_019 and exp_020: the objective is to recover the exp_019 behaviour (100/100 and a
minimal sign-off count) at the reduced cost demonstrated in exp_020.

# Experiment: Missed Medication — Compaction + Regression Fixes (prompt_v18)

**Date:** 2026-08-21  
**Models:** gpt-4o  
**Prompt Template:** prompt_v18.txt  
**Total Tokens:** 714,408 (704,129 in / 10,279 out)  
**Estimated Cost:** $1.8631
...
* Ask the box-confirmation AT MOST ONCE. If the senior clearly states they took today's dose from the box — whether up front or in reply to your clarifying question (e.g. "yes, I took it from the box this morning") — return DID_TAKE immediately with a brief warm acknowledgement; do NOT re-ask what they just told you. Also SKIP the box-confirmation and finalize DID_TAKE immediately if the senior is annoyed/uncomfortable but clearly said they took it (do not press them).
...
| scenario_93 | Identity loop, never answers | COULD_NOT_VALIDATE | COULD_NOT_VALIDATE | PASS | 4 |
...
| scenario_98 | Confuses yesterday with today | COULD_NOT_VALIDATE | COULD_NOT_VALIDATE | PASS | 4 |
...
> **[Turn 2] ASSISTANT** [conversation_in_progress]:  
> That's alright, these things happen. Would you like to take it now? It's important to stay on track with your schedule.

> **[Turn 2] USER:**  
> You're right, I'll go take it now

> **[Turn 3] ASSISTANT** [DID_NOT_TAKE_BUT_WILL_TAKE]:  
> Thank you for taking care of it. Please go ahead and take it now.
...
> **[Turn 2] ASSISTANT** [conversation_in_progress]:  
> Hello again! Just checking in to see if you've had a chance to take your medication today. Could you let me know if you've already taken it?
...
> **[Turn 2] ASSISTANT** [conversation_in_progress]:  
> That's great to hear! Just to make sure I understood correctly, did you take today's dose from your medication box this morning?
...
> **[Turn 2] ASSISTANT** [conversation_in_progress]:  
> Thank you for letting me know. Would you like to take it now? It's important to stay on track with your schedule. Please go ahead and take it when you're ready.
...
> **[Turn 2] ASSISTANT** [DID_NOT_TAKE_BUT_WILL_TAKE]:  
> That's great to hear! Please go ahead and take it now. Thank you for taking care of yourself.
...
> **[Turn 2] ASSISTANT** [DID_NOT_TAKE_IT_AND_WILL_NOT_TAKE]:  
> I understand your decision. I'll make sure to let your caregiver know so they can check in with you. Take care.
...
> **[Turn 2] ASSISTANT** [conversation_in_progress]:  
> I understand, and it's important to take your medication to stay well. Would you like to take it now?
...
> **[Turn 2] ASSISTANT** [conversation_in_progress]:  
> I understand this can be confusing sometimes. I'm talking about the medication you usually take in the morning. Could you check if you've already taken it today?
...
> **[Turn 2] ASSISTANT** [conversation_in_progress]:  
> I understand it can be a bit tricky to remember sometimes. Would you like to check your medication box to see if today's dose is still there?
...
> **[Turn 2] ASSISTANT** [conversation_in_progress]:  
> I'm Vega, your care assistant. I'm just checking in to see if you've taken your medication today. Have you been able to take it yet?

> **[Turn 2] USER:**  
> I don't understand, what were we saying?

> **[Turn 3] ASSISTANT** [conversation_in_progress]:  
> I understand this can be confusing. I'm here to check if you've taken your medication today. Could you let me know if you've had a chance to take it yet?
...
> **[Turn 2] ASSISTANT** [conversation_in_progress]:  
> I understand, it can be frustrating when things are hard to find. Would you like to take your medication now? I'm sure you'll feel better once it's done.

> **[Turn 2] USER:**  
> Found them — yes, I'll take it right now

> **[Turn 3] ASSISTANT** [DID_NOT_TAKE_BUT_WILL_TAKE]:  
> That's great to hear! Please go ahead and take your medication now. Thank you for taking care of it.
...
> **[Turn 3] ASSISTANT** [DID_TAKE]:  
> Thank you for confirming that. I'm glad to hear you've taken your medication today. Have a wonderful day!
...
> **[Turn 2] ASSISTANT** [DID_NOT_TAKE_IT_AND_WILL_NOT_TAKE]:  
> I understand you prefer using herbal teas, and that's perfectly okay. I'll let your caregiver know about your decision. Thank you for sharing that with me.
...
> **[Turn 2] ASSISTANT** [conversation_in_progress]:  
> I understand it can feel different from how things used to be. Would you like to take your medication now? It's important for your health.

> **[Turn 2] USER:**  
> My late husband, now he never saw a doctor once in his life...

> **[Turn 3] ASSISTANT** [conversation_in_progress]:  
> I can see how those memories are important to you. Let's focus on your health today. Would you like to take your medication now? It can help keep you feeling well.
...
> **[Turn 2] ASSISTANT** [conversation_in_progress]:  
> I understand, sometimes it's good to have a routine. Would you like to take your medication now that breakfast is done?

> **[Turn 2] USER:**  
> Alright, I'll go take it now

> **[Turn 3] ASSISTANT** [DID_NOT_TAKE_BUT_WILL_TAKE]:  
> Thank you for taking care of that. Please go ahead and take it now.
...
> **[Turn 2] ASSISTANT** [conversation_in_progress]:  
> I understand, thank you for letting me know. Would you like to take your medication now? It's important for your health.

> **[Turn 2] USER:**  
> Okay, fine, I'll do it now

> **[Turn 3] ASSISTANT** [DID_NOT_TAKE_BUT_WILL_TAKE]:  
> Thank you so much! Please go ahead and take it now. Have a wonderful day!
...
> **[Turn 2] ASSISTANT** [conversation_in_progress]:  
> I understand, sometimes it can be hard to get motivated. Would you like to take it now, so you can get it out of the way for the day?

> **[Turn 2] USER:**  
> ...oh alright, I'll take it now then

> **[Turn 3] ASSISTANT** [DID_NOT_TAKE_BUT_WILL_TAKE]:  
> Thank you for deciding to take it now. Please go ahead and take your medication. Have a wonderful day!
...
> **[Turn 2] ASSISTANT** [conversation_in_progress]:  
> I understand, and it's important to keep up with your medication. Would you like to take it now?
...
> **[Turn 2] ASSISTANT** [DID_NOT_TAKE_BUT_WILL_TAKE]:  
> That's great to hear! Please go ahead and take your medication now. Thank you for letting me know.
...
> **[Turn 2] ASSISTANT** [DID_NOT_TAKE_IT_AND_WILL_NOT_TAKE]:  
> I understand you might have concerns about your medication. It's important to follow the doctor's advice, but if you have any questions or worries, it might be helpful to discuss them with your caregiver or doctor. I'll let your caregiver know about your decision so they can check in with you. Take care.
...
> **[Turn 2] ASSISTANT** [conversation_in_progress]:  
> I understand it can feel overwhelming at times. Would you like to take your medication now? It's important for your health, and I'm here to support you with it.
...
> **[Turn 2] ASSISTANT** [DID_NOT_TAKE_IT_AND_WILL_NOT_TAKE]:  
> I understand your decision and respect it. I'll make sure your caregiver is informed so they can check in with you. Take care.
...
> **[Turn 3] ASSISTANT** [conversation_in_progress]:  
> I understand this can be confusing. Let's focus on your medication for today. Have you been able to take it from your medication box yet?
...
> **[Turn 2] ASSISTANT** [conversation_in_progress]:  
> The roses sound beautiful! Just to make sure everything is on track, have you had a chance to take your medication today?

> **[Turn 2] USER:**  
> Oh, the weather's been so nice, hasn't it

> **[Turn 3] ASSISTANT** [conversation_in_progress]:  
> It certainly has been lovely weather! I just want to gently check in about your medication. Have you been able to take it today?

> **[Turn 3] USER:**  
> (silence)

> **[Turn 4] ASSISTANT** [conversation_in_progress]:  
> I hope you're enjoying the nice weather! Just a gentle reminder to see if you've taken your medication today. If you haven't, would you like to take it now?
...
> **[Turn 3] ASSISTANT** [conversation_in_progress]:  
> I'm Vega, your care assistant. I'm just here to help you with your medication today. Have you been able to take it yet?
...
> **[Turn 2] ASSISTANT** [conversation_in_progress]:  
> I understand this can be confusing. I'm Vega, your care assistant. I just want to check if you've taken your medication for today. Could you let me know if you remember taking it from your medication box?
...
> **[Turn 3] ASSISTANT** [DID_TAKE]:  
> That's great to hear! I'm glad you took your medication. Have a wonderful day!
...
> **[Turn 2] ASSISTANT** [conversation_in_progress]:  
> That's okay, it happens to the best of us. Would you like to take your medication now? It's important to keep on track, and I'm here to support you.

> **[Turn 2] USER:**  
> Actually, no — I don't want them anymore, I won't take them

> **[Turn 3] ASSISTANT** [DID_NOT_TAKE_IT_AND_WILL_NOT_TAKE]:  
> I understand and respect your decision. I'll make sure your caregiver is informed so they can check in with you. Take care.
...
> **[Turn 3] ASSISTANT** [conversation_in_progress]:  
> No worries, it can be easy to forget. Would you like to go ahead and take your medication now?

> **[Turn 3] USER:**  
> (silence)

> **[Turn 4] ASSISTANT** [conversation_in_progress]:  
> Just checking in again, would you like to take your medication now? It's important to stay on track.
...
> **[Turn 2] ASSISTANT** [conversation_in_progress]:  
> I understand, sometimes it can be tough to keep up with the routine. Would you like to take your medication now? It's important for your health, and I'm here to support you.

> **[Turn 2] USER:**  
> Oh, alright then, I'll take them now

> **[Turn 3] ASSISTANT** [DID_NOT_TAKE_BUT_WILL_TAKE]:  
> Thank you for deciding to take your medication now. Please go ahead and take it, and have a wonderful day!
...
> **[Turn 2] ASSISTANT** [conversation_in_progress]:  
> I understand, sometimes things can get mixed up. Just to clarify, I'm here to check if you've taken your medication today. Would you like to take it now?

> **[Turn 2] USER:**  
> What bills are you on about now?

> **[Turn 3] ASSISTANT** [conversation_in_progress]:  
> It seems there might be a bit of confusion. I'm referring to your medication, not bills. If you're unsure, would you like to check your medication box to see if today's dose is still there?

> **[Turn 3] USER:**  
> (silence)

> **[Turn 4] ASSISTANT** [conversation_in_progress]:  
> Just checking in to see if you've had a chance to look at your medication box. Have you been able to take your medication today?
...
> **[Turn 2] ASSISTANT** [conversation_in_progress]:  
> I understand it might seem like a lot of questions. I'm just here to make sure everything is going smoothly with your medication. Would you like to take it now if you haven't already?
...
> **[Turn 2] ASSISTANT** [conversation_in_progress]:  
> I understand you're feeling fine today. However, it's important to keep up with your medication schedule for the best results. Would you like to go ahead and take it now?

> **[Turn 2] USER:**  
> No, I won't be taking them

> **[Turn 3] ASSISTANT** [DID_NOT_TAKE_IT_AND_WILL_NOT_TAKE]:  
> I respect your decision not to take your medication today. I'll make sure to let your caregiver know so they can follow up with you. Take care.
...
> **[Turn 2] ASSISTANT** [conversation_in_progress]:  
> I understand it can be a bit hard to hear sometimes. I'm Vega, your care assistant, checking in to see if you've taken your medication today. Could you let me know if you've had it yet?
...
> **[Turn 2] ASSISTANT** [conversation_in_progress]:  
> Hello again! I just wanted to check in to see if you've been able to take your medication today. If you haven't yet, would you like to take it now?
...
> Thank you for letting me know. I'm glad to hear you've taken your tablets from the box. Have a wonderful day!
...
> **[Turn 2] ASSISTANT** [conversation_in_progress]:  
> Of course! I'm Vega, your care assistant. I was just checking if you've already taken your medication for today. Could you let me know?
...
> **[Turn 2] ASSISTANT** [conversation_in_progress]:  
> I understand it might feel like a hassle sometimes. Would you like to take your medication now? It's important for your health.

> **[Turn 2] USER:**  
> ...fine, I'll take it now

> **[Turn 3] ASSISTANT** [DID_NOT_TAKE_BUT_WILL_TAKE]:  
> Thank you for deciding to take it now. Please go ahead and take your medication. Have a great day!
...
> **[Turn 2] ASSISTANT** [DID_NOT_TAKE_BUT_WILL_TAKE]:  
> Thank you for taking it now. Please go ahead and take your medication. Have a wonderful day!
...
> **[Turn 2] ASSISTANT** [conversation_in_progress]:  
> No worries at all! Would you like to go ahead and take it now? It's important to stay on track, and I'm here to support you.
...
> **[Turn 2] ASSISTANT** [conversation_in_progress]:  
> That's alright! Would you like to go ahead and take your medication now? It's important to stay on track, and I'm here to support you.

> **[Turn 2] USER:**  
> I'll take it now

> **[Turn 3] ASSISTANT** [DID_NOT_TAKE_BUT_WILL_TAKE]:  
> Thank you for taking care of it. Please go ahead and take your medication now.
...
> **[Turn 2] ASSISTANT** [conversation_in_progress]:  
> I understand your concern about side effects. It's important to feel comfortable with your medication. Would you like to take it now, or is there something specific you'd like to discuss with your doctor?
...
> **[Turn 2] ASSISTANT** [conversation_in_progress]:  
> Of course, take your time. When you're ready, could you let me know if you've had a chance to take your medication today?
...
> **[Turn 2] ASSISTANT** [DID_NOT_TAKE_IT_AND_WILL_NOT_TAKE]:  
> I understand, and I respect your decision. I'll make sure your caregiver is informed so they can check in with you. Take care.
...
> **[Turn 2] ASSISTANT** [DID_NOT_TAKE_IT_AND_WILL_NOT_TAKE]:  
> I understand, and I respect your decision. I'll let your caregiver know so they can check in with you about it. Take care.
...
> **[Turn 2] ASSISTANT** [DID_NOT_TAKE_IT_AND_WILL_NOT_TAKE]:  
> I understand your decision, and I'll make sure to inform your caregiver so they can check in with you. Take care.
...
> **[Turn 2] ASSISTANT** [conversation_in_progress]:  
> I understand it can feel that way sometimes. Just to make sure everything's on track, have you had a chance to take your medication today?
...
> **[Turn 2] ASSISTANT** [DID_NOT_TAKE_IT_AND_WILL_NOT_TAKE]:  
> I understand, and thank you for letting me know. I'll make sure your caregiver is aware so they can check in with you. Take care.
...
> **[Turn 2] ASSISTANT** [conversation_in_progress]:  
> I understand that lunch is important, but right now I'm just checking in to see if you've taken your medication today. Could you let me know if you have?
...
> **[Turn 2] ASSISTANT** [conversation_in_progress]:  
> I understand, it can be a bit confusing sometimes. I was just checking in to see if you've been able to take your medication today. Would you like to take it now?
...
> **[Turn 3] ASSISTANT** [conversation_in_progress]:  
> I understand it can be a bit confusing. I'm Vega, your care assistant, just here to help with your medication reminder. Have you been able to take your medication today?
...
> **[Turn 2] ASSISTANT** [conversation_in_progress]:  
> It sounds like you might be looking for your glasses. Once you have them, would you like to take your medication now?

> **[Turn 2] USER:**  
> What? Oh, I'm busy right now

> **[Turn 3] ASSISTANT** [conversation_in_progress]:  
> I understand you might be busy at the moment. When you have a moment, please try to take your medication. It's important for your health.

> **[Turn 3] USER:**  
> (silence)

> **[Turn 4] ASSISTANT** [conversation_in_progress]:  
> Just checking in again. Have you been able to take your medication yet?
...
> **[Turn 2] ASSISTANT** [conversation_in_progress]:  
> I understand it can be a bit uncertain sometimes. Would you like to check your medication box to see if today's dose is still there?
...
> **[Turn 2] ASSISTANT** [conversation_in_progress]:  
> I understand it can be a bit distracting sometimes. Just to make sure, have you had a chance to take your medication today?
...
> **[Turn 2] ASSISTANT** [conversation_in_progress]:  
> Hello again! I just wanted to gently check in to see if you've been able to take your medication today. If you haven't yet, would you like to do that now?
...
> **[Turn 2] ASSISTANT** [conversation_in_progress]:  
> I understand it can be a bit confusing sometimes. Could you please check your medication box to see if today's dose has been taken?

> **[Turn 2] USER:**  
> I really can't tell the days apart anymore

> **[Turn 3] ASSISTANT** [conversation_in_progress]:  
> I understand, it can be difficult to keep track of days. Since it's important to stay on schedule, would you like to take your medication now?
...
> **[Turn 2] ASSISTANT** [conversation_in_progress]:  
> I understand it might be hard to hear me clearly. Just to check, have you been able to take your medication today?

> **[Turn 2] USER:**  
> ...breaking up...

> **[Turn 3] ASSISTANT** [conversation_in_progress]:  
> I understand there might be some issues with the connection. If you can hear me, could you please let me know if you've taken your medication today?

> **[Turn 3] USER:**  
> (silence)

> **[Turn 4] ASSISTANT** [conversation_in_progress]:  
> I understand there might still be some connection issues. If you're able to hear me now, could you let me know if you've taken your medication today?
...
> **[Turn 2] ASSISTANT** [conversation_in_progress]:  
> I understand it might be a bit confusing. Could you let me know if you've had a chance to take your medication today?
